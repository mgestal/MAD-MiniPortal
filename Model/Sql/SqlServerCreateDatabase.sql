...
SET @sql = 
  N'CREATE DATABASE [miniportal] 
    ON PRIMARY ( NAME = miniportal, FILENAME = "' + @Default_DB_Path + N'miniportal.mdf")
    LOG ON ( NAME = miniportal_log, FILENAME = "' + @Default_DB_Path + N'miniportal_log.ldf")'

EXEC(@sql)
PRINT N'Database [MiniPortal] created.'
GO
